...
![MEF安装流程图](./docs/zh/figures/MEF安装流程图.png)

- [安装部署MEF Center](./docs/zh/user_guide/installation_guide.md#安装部署mef-center)

- [安装部署MEF Edge](./docs/zh/user_guide/installation_guide.md#安装部署mef-edge)
